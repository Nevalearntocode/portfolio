...
export function AvailabilityCard() {
  ...
  return (
    <TiltCard className="rounded-2xl border border-black/8 dark:border-white/8 bg-white/60 dark:bg-white/4 backdrop-blur-sm px-5 py-4 flex items-center gap-3">

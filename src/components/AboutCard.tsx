...
export function AboutCard() {
  ...
  return (
    <TiltCard id="about" className="rounded-2xl border border-black/[0.08] dark:border-white/[0.08] bg-white/60 dark:bg-white/[0.04] backdrop-blur-sm p-6 flex flex-col gap-3 h-full">
      <div>
